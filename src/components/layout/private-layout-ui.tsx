...
import { usePrivateLayout } from '@/providers/private-layout-provider'
...
interface PrivateLayoutUIProps {
  children: React.ReactNode
}

export function PrivateLayoutUI({ children }: PrivateLayoutUIProps) {
  ...
  const allSidebarItems = [
    ...
    { id: 'partnership-requests', label: 'Solicitações de Parceria', icon: HandshakeIcon, href: '/partnership-requests', resource: 'partnerships', action: 'READ' as const },
    { id: 'supplier-subscription', label: 'Planos de Assinatura', icon: Crown, href: '/supplier-subscription', resource: 'supplier', action: 'READ' as const },
