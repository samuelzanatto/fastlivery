...
export default function SubscriptionCheckout() {
  ...
  const handlePayment = async () => {
    ...
    try {
      // Obter restaurantId do localStorage ou context
      const restaurantData = localStorage.getItem('restaurantSetup')
      if (!restaurantData) {
        alert('Dados do restaurante não encontrados. Faça o setup primeiro.')
        return
      }

      const { restaurantId } = JSON.parse(restaurantData)
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="text-slate-600">
            Apenas mais um passo para revolucionar seu restaurante
          </p>
        </motion.div>
            ...
            {!isProcessing && (
              ...
              >
                ...
                <div className="space-y-2 text-sm text-slate-600">
                  ...
                  <p>2. Configure seu restaurante</p>
